...
<html>
    ...
    <link href="./css/thiswork.css" rel="stylesheet"/></head>
    <style>
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="/projects/{{ $project->id}}" method="POST" class="styled-table">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group mb-3">
                            <label  class="label" for="">Project Content :&nbsp;</label>
                            <input type="text" name="content" value="{{ $project->content}}" class="form-control">
                        </div>
